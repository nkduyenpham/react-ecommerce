                ...
                <div className="flex flex-1 items-center justify-end md:justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="sm:flex sm:gap-4">
                            <a
                                className="block rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-white transition hover:bg-black"
                                href="#"
                            >
                                Login
                            </a>
                            ...
                            <a
                                className="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-black transition hover:bg-white hover:text-black sm:block"
                                href="#"
                            >
                                Register
                            </a>
